...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ifbcat_api', '0033_auto_20200720_1255'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='event',
            name='dates',
            field=models.ManyToManyField(help_text='Dates or periodes on which the event takes place', related_name='dates', to='ifbcat_api.EventDate'),
        ),
        migrations.CreateModel(
            name='ElixirPlatform',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisations', models.ManyToManyField(help_text='An organisation to which the community is affiliated.', related_name='communities', to='ifbcat_api.Organisation')),
            ],
        ),
    ]
