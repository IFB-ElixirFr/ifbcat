...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ifbcat_api', '0058_create_organisation_field'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communities', models.ManyToManyField(blank=True, help_text='Community which uses the resource.', related_name='resources', to='ifbcat_api.Community')),
                ('elixirPlatforms', models.ManyToManyField(blank=True, help_text='ELIXIR Platform which uses the resource.', related_name='resources', to='ifbcat_api.ElixirPlatform')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.ManyToManyField(blank=True, help_text='A keyword (beyond EDAM ontology scope) describing the training material.', related_name='trainingMaterials', to='ifbcat_api.EventKeyword')),
                ('topics', models.ManyToManyField(blank=True, help_text='URI of EDAM Topic term describing the scope of the training material.', related_name='trainingMaterials', to='ifbcat_api.EventTopic')),
            ],
