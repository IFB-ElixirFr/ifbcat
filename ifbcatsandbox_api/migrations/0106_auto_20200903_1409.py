...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ifbcatsandbox_api', '0105_auto_20200903_1407'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communities', models.ManyToManyField(blank=True, help_text='Community which uses the resource.', to='ifbcatsandbox_api.Community')),
                ('elixirPlatforms', models.ManyToManyField(blank=True, help_text='ELIXIR Platform which uses the resource.', to='ifbcatsandbox_api.ElixirPlatform')),
                ('keywords', models.ManyToManyField(blank=True, help_text='A keyword (beyond EDAM ontology scope) describing the training material.', related_name='trainingMaterials', to='ifbcatsandbox_api.Keyword')),
                ('providedBy', models.ManyToManyField(blank=True, help_text='The bioinformatics team that provides the training material.', related_name='trainingMaterials', to='ifbcatsandbox_api.BioinformaticsTeam')),
                ('topics', models.ManyToManyField(blank=True, help_text='URIs of EDAM Topic terms describing the scope of the training material.', related_name='trainingMaterials', to='ifbcatsandbox_api.Topic')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communities', models.ManyToManyField(blank=True, help_text='Community which uses the resource.', to='ifbcatsandbox_api.Community')),
                ('elixirPlatforms', models.ManyToManyField(blank=True, help_text='ELIXIR Platform which uses the resource.', to='ifbcatsandbox_api.ElixirPlatform')),
                ('providedBy', models.ForeignKey(help_text='The bioinformatics team that provides the computing facility.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='computingFacilityProvidedBy', to='ifbcatsandbox_api.BioinformaticsTeam')),
                ('team', models.ForeignKey(help_text='The team which is maintaining the computing facility.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='computingFacilityTeam', to='ifbcatsandbox_api.Team')),
                ('trainingMaterials', models.ManyToManyField(blank=True, help_text='Training material for the computing facility.', related_name='computingFacilities', to='ifbcatsandbox_api.TrainingMaterial')),
                ('user_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Training material(s) provided by the service.', related_name='servicesTrainingMaterials', to='ifbcatsandbox_api.TrainingMaterial'),
        ),
        migrations.AddField(
            model_name='trainingevent',
            name='computingFacilities',
            field=models.ManyToManyField(blank=True, help_text='Computing facilities that the training event uses.', related_name='trainingEvents', to='ifbcatsandbox_api.ComputingFacility'),
        ),
        migrations.AddField(
            model_name='trainingevent',
            name='trainingMaterials',
            field=models.ManyToManyField(blank=True, help_text='Training material that the training event uses.', related_name='trainingEvents', to='ifbcatsandbox_api.TrainingMaterial'),
        ),
    ]
