...
def migration_code_type(apps, schema_editor):
    AudienceType = apps.get_model("ifbcatsandbox_api", "AudienceType")
...
def migration_code_role(apps, schema_editor):
    AudienceRole = apps.get_model("ifbcatsandbox_api", "AudienceRole")
...
def migration_code_licence(apps, schema_editor):
    TrainingMaterialLicense = apps.get_model("ifbcatsandbox_api", "TrainingMaterialLicense")
...
class Migration(migrations.Migration):
    dependencies = [
        ('ifbcatsandbox_api', '0061_auto_20200723_0940'),
    ]
