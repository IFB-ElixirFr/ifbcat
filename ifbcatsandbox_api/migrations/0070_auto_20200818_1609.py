...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ifbcatsandbox_api', '0069_auto_20200813_1204'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expertise', models.ManyToManyField(help_text='URIs of EDAM Topic terms describing the expertise of the project.', related_name='teams', to='ifbcatsandbox_api.EventTopic')),
        ...
        migrations.AlterField(
            model_name='event',
            name='topics',
            field=models.ManyToManyField(help_text='URIs of EDAM Topic terms describing the scope of the event.', related_name='events', to='ifbcatsandbox_api.EventTopic'),
        ),
        migrations.AlterField(
            model_name='project',
            name='topics',
            field=models.ManyToManyField(help_text='URIs of EDAM Topic terms describing the expertise of the project.', related_name='projects', to='ifbcatsandbox_api.EventTopic'),
        ),
        migrations.AlterField(
            model_name='trainingmaterial',
            name='topics',
            field=models.ManyToManyField(blank=True, help_text='URIs of EDAM Topic terms describing the scope of the training material.', related_name='trainingMaterials', to='ifbcatsandbox_api.EventTopic'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topics', models.ManyToManyField(blank=True, help_text='URIs of EDAM Topic terms describing the bioinformatics team.', related_name='bioinformaticsTeams', to='ifbcatsandbox_api.EventTopic')),
            ],
